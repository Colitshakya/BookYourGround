...
<!-- Main tennis courts listing page content -->
<main class="courts-page">
    <div class="courts-container">

        <!-- Tennis courts hero section -->
        <section class="courts-hero">
            <p class="courts-hero-tag">TENNIS COURTS</p>
            <h1>Choose your tennis court</h1>
            <p class="courts-hero-text">Browse available tennis courts and book your next session.</p>
        </section>
        ...
        <!-- Tennis courts list section -->
        <section class="courts-list-section">
            <div class="court-grid">

                <!-- Looping through courtList and displaying each tennis court card -->
                ...
                <!-- Empty message shown when no tennis courts are available -->
