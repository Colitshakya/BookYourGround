...
<!-- Main futsal courts listing page content -->
<main class="courts-page">
    <div class="courts-container">

        <!-- Futsal courts hero section -->
        <section class="courts-hero">
            <p class="courts-hero-tag">FUTSAL COURTS</p>
            <h1>Choose your futsal court</h1>
            <p class="courts-hero-text">Browse available futsal grounds and book your next match.</p>
        </section>
        ...
        <section class="courts-list-section">
            <div class="court-grid">
                ...
                <!-- Looping through courtList and displaying each futsal court card -->
                ...
                <!-- Empty message shown when no futsal courts are available -->
