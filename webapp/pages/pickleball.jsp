...
<main class="courts-page">
    <div class="courts-container">
        ...
        <section class="courts-hero">
            <p class="courts-hero-tag">PICKLEBALL COURTS</p>
<h1>Choose your pickleball court</h1>
<p class="courts-hero-text">Browse available pickleball courts and book your next match.</p>
        </section>
